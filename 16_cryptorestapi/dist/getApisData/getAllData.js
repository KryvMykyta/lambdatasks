...
function getAllData() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const marketCap = yield (0, coinmarketcap_1.getMarketCap)();
        ...
        let marketCapCurrencies = Object.keys(marketCap);
        let currencies = [...new Set([...paprikaCurrencies, ...coinBaseCurrencies, ...kucoinCurrencies, ...coinStatsCurrencies, ...marketCapCurrencies])];
        let allCurrencies = currencies.filter((el) => {
            return paprikaCurrencies.includes(el) && coinBaseCurrencies.includes(el) && coinStatsCurrencies.includes(el) && marketCapCurrencies.includes(el) && kucoinCurrencies.includes(el);
        });
        let resObj = {};
