...
console.log([1,2,3,4,5].all((value: number) =>{
    return value > 3
}))
...
console.log([1,2,3,4,5].any((value: number)=>{
    return value > 3
}))
...
console.log(testFilter.filter((el: number) => {
    return el%2 === 0
}))
...
console.log(testFilterIndexed.filterIndexed((index: number, element: any) => {
...
console.log(testFilter.filterNot((el: number) => {
    return el%3 === 0
}))
...
console.log(testFind.find((el: number) => {
    return el%2 !== 0
}))
...
console.log(testFind.findLast((el: number) => {
    return el%2 === 0
}))
